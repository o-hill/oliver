...
Changing the reward structure was the most interesting part of the project.  Watching what choices the network will make after being rewarded with different functions is fascinating, and exemplifies why continuous state and action problems are so difficult to reward. How do you reward an agent that is trying to cook a meal? Once when it's done?
